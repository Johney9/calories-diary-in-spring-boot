...
public interface CreateMealApi {
    ...
    ResponseEntity<Meal> createMeal(@ApiParam(value = "Date of meal", required = true) @RequestParam(value = "mealDate", required = true) @DateTimeFormat(pattern = "YYYY-MM-DD") String mealDate,
